...
/**
 * Integration tests with mocked HTTP/CI responses.
 * These tests verify download configuration and mock CI behaviors without hitting real systems.
 */
class CiIntegrationTest {
    ...
    void testMockHttpCIRespondsWithBearerAuth() throws Exception {
        ...
        mockHttpCI.enqueue(new MockResponse()
                .setBody(depsJson)
                .addHeader("Content-Type", "application/json"));
    ...
    void testMockServerURLConstruction() throws Exception {
        ...
        String constructedUrl = baseUrl.newBuilder()
