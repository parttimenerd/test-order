...
public class GitChangeDetector {
    ...
    /**
     * Returns FQCNs of Java classes changed between a commit ref and HEAD, under the given source prefix.
     */
    public static Set<String> changedSinceCommit(Path projectRoot, String commitRef, String sourcePrefix) throws IOException {
        List<String> files = runGit(projectRoot,
                "diff", "--name-only", commitRef, "HEAD", "--", sourcePrefix);
