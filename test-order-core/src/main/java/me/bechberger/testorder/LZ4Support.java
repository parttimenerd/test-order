...
public final class LZ4Support {
	...
	public static LZ4FrameOutputStream frameOutputStream(OutputStream out) throws IOException {
		return new LZ4FrameOutputStream(out, LZ4FrameOutputStream.BLOCKSIZE.SIZE_4MB, -1L,
				FACTORY.fastCompressor(), HASH_FACTORY.hash32(),
	...
	/** Creates an LZ4 block output stream using the safe (no-Unsafe) compressor and checksum. */
	...
	/** Creates an LZ4 block input stream using the safe (no-Unsafe) decompressor and checksum. */
