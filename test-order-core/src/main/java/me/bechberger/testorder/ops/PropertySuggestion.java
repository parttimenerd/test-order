...
public final class PropertySuggestion {
	...
	public static final Set<String> KNOWN_KEYS = Set.of("testorder.mode", "testorder.skip", "testorder.debug",
			...
			"testorder.explain.topN", "testorder.score.newTest", "testorder.score.changedTest",
			"testorder.score.maxFailure", "testorder.score.speed", "testorder.score.speedPenalty",
			"testorder.score.depOverlap", "testorder.score.changeComplexity", "testorder.score.staticFieldBonus",
			"testorder.score.coverageBonus", "testorder.score.killRateBonus", "testorder.score.springContextGrouping",
			"testorder.dump.output", "testorder.exportJson.output", "testorder.dashboard.output",
			"testorder.dashboard.open", "testorder.dashboard.port", "testorder.serve.port",
			"testorder.dashboard.serveSeconds", "testorder.dashboard.regenerate", "testorder.dashboard.separateAssets",
			"testorder.metrics.output", "testorder.history.maxRuns", "testorder.remaining.file",
			...
			"testorder.git.timeout.seconds", "testorder.lock.stale.minutes", "testorder.change.complexity",
