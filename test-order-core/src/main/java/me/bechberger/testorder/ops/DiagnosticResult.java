...
/**
 * Result of a diagnostic check, containing error code, message, suggestions, and context.
 * Used by testOrderDiagnose and for programmatic error handling.
 */
public record DiagnosticResult(
     ...
     */
    public static DiagnosticResult error(
            ErrorCode code,
            String message,
            List<String> suggestions,
            Map<String, String> context) {
