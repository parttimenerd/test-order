...
/**
 * A conflict graph where edges represent pairs of tests that share mutable state
 * and whose relative ordering may trigger OD failures.
 */
public class ConflictGraph {
     ...
     *
     * @param testA first test (FQCN)
     * @param testB second test (FQCN)
     * @param sharedMembers the shared fields (e.g., "com.example.Service#cache")
     * @param weight edge weight (0.0–1.0) representing likelihood of OD
     */
    public record ConflictEdge(String testA, String testB, Set<String> sharedMembers, double weight)
            implements Comparable<ConflictEdge> {
