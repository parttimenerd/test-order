...
/**
 * Structured logging utility for test-order operations. Produces
 * JSON-compatible log lines that can be parsed by CI/CD systems.
 *
 * <p>
 * Format: {@code [test-order] <LEVEL> <CODE> <MESSAGE> | <JSON_CONTEXT>}
 *
 * <p>
 * Example: {@code [test-order] INFO MODE_DECISION order | {"reason":"Index
 * exists","mode":"order","timestamp":"2026-04-29T10:30:00Z"}}
 */
