...
/**
 * Test execution metrics for export and reporting. Captures performance data,
 * coverage, and test-order effectiveness.
 */
public record TestMetricsExport(String timestamp, String project, String mode, Map<String, Object> metrics,
		Map<String, Object> changesDetected, Map<String, Object> indexHealth, List<String> recommendations) {
	...
	public static class Builder {
		...
		public TestMetricsExport build() {
			return new TestMetricsExport(Instant.now().toString(), project, mode, Map.copyOf(metrics),
					Map.copyOf(changesDetected), Map.copyOf(indexHealth), List.copyOf(recommendations));
		}
	}
