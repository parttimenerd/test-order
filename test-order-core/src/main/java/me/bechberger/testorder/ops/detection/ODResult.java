 ...
 *
 * @param victim
 *            the test that fails or needs help
 * @param type
 *            the OD pattern type
 * @param dependencyChain
 *            the minimal sequence exhibiting the dependency
 * @param description
 *            human-readable explanation
 * @param confidence
 *            0.0–1.0 confidence in this result
 */
public record ODResult(String victim, ODType type, List<String> dependencyChain, String description,
		double confidence) {
