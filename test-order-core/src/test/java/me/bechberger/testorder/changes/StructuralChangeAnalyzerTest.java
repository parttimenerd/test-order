...
class StructuralChangeAnalyzerTest {
    ...
    private static StructuralDiff.Change createChange(
            StructuralDiff.Change.Kind kind,
            StructuralDiff.Change.Category category,
            String fqcn,
            String name,
            String detail) {
    ...
    class FromDiffsBasic {
        ...
        void emptyDiffsReturnsEmpty() {
            ...
            StructuralChangeAnalyzer.ChangedMembers result =
                StructuralChangeAnalyzer.fromDiffs(diffs);
        ...
        void typeLevelChangeMarksTypeChanged() {
            StructuralDiff.Change typeChange = createChange(
                StructuralDiff.Change.Kind.MODIFIED,
                StructuralDiff.Change.Category.TYPE,
                "com.example.Foo",
                "Foo",
                "superclass changed"
            );
            List<StructuralDiff.FileDiff> diffs = List.of(
                createFileDiff(Path.of("Foo.java"), List.of(typeChange))
            );
            ...
            // TYPE changes should not produce member keys (they return null from resolveMemberName)
            assertTrue(result.changedMemberKeys().isEmpty());
        }
        ...
        void staticInitializerChangeDetected() {
            StructuralDiff.Change clinitChange = createChange(
                StructuralDiff.Change.Kind.MODIFIED,
                StructuralDiff.Change.Category.INITIALIZER,
                "com.example.Config",
                "<clinit>",
                "static { ... }"
            );
            List<StructuralDiff.FileDiff> diffs = List.of(
                createFileDiff(Path.of("Config.java"), List.of(clinitChange))
            );
        ...
        void constructorChangeDetected() {
            StructuralDiff.Change constructorChange = createChange(
                StructuralDiff.Change.Kind.ADDED,
                StructuralDiff.Change.Category.METHOD,
                "com.example.MyClass",
                "MyClass",
                "constructor public MyClass(int x)"
            );
            List<StructuralDiff.FileDiff> diffs = List.of(
                createFileDiff(Path.of("MyClass.java"), List.of(constructorChange))
            );
        ...
        void regularMethodChange() {
            StructuralDiff.Change methodChange = createChange(
                StructuralDiff.Change.Kind.MODIFIED,
                StructuralDiff.Change.Category.METHOD,
                "com.example.Helper",
                "compute",
            ...
            List<StructuralDiff.FileDiff> diffs = List.of(
                createFileDiff(Path.of("Helper.java"), List.of(methodChange))
            );
        ...
        void fieldChange() {
            StructuralDiff.Change fieldChange = createChange(
                StructuralDiff.Change.Kind.ADDED,
                StructuralDiff.Change.Category.FIELD,
                "com.example.Data",
                "value",
                "private int value"
            );
            List<StructuralDiff.FileDiff> diffs = List.of(
                createFileDiff(Path.of("Data.java"), List.of(fieldChange))
            );
        ...
        void staticFieldChange() {
            StructuralDiff.Change staticFieldChange = createChange(
                StructuralDiff.Change.Kind.MODIFIED,
                StructuralDiff.Change.Category.FIELD,
            ...
            List<StructuralDiff.FileDiff> diffs = List.of(
                createFileDiff(Path.of("Constants.java"), List.of(staticFieldChange))
            );
        ...
        void instanceInitializerChange() {
            StructuralDiff.Change initChange = createChange(
                StructuralDiff.Change.Kind.ADDED,
                StructuralDiff.Change.Category.INITIALIZER,
                "com.example.Lazy",
                "<init>",
            ...
            List<StructuralDiff.FileDiff> diffs = List.of(
                createFileDiff(Path.of("Lazy.java"), List.of(initChange))
            );
        ...
        void multipleChangesInOneClass() {
            ...
            List<StructuralDiff.FileDiff> diffs = List.of(
                createFileDiff(Path.of("Service.java"), changes)
            );
        ...
        void multipleFilesMultipleClasses() {
            List<StructuralDiff.Change> file1Changes = List.of(
                createChange(
                    StructuralDiff.Change.Kind.MODIFIED,
                    StructuralDiff.Change.Category.METHOD,
                    "com.example.Foo",
            ...
            List<StructuralDiff.Change> file2Changes = List.of(
                createChange(
                    StructuralDiff.Change.Kind.ADDED,
                    StructuralDiff.Change.Category.METHOD,
                    "com.example.Baz",
            ...
            List<StructuralDiff.FileDiff> diffs = List.of(
                createFileDiff(Path.of("Foo.java"), file1Changes),
    ...
    class FromDiffsStaticFields {
        ...
        void detectsStaticModifier() {
            StructuralDiff.Change change = createChange(
                StructuralDiff.Change.Kind.ADDED,
                StructuralDiff.Change.Category.FIELD,
                "com.example.Statics",
                "INSTANCE",
            ...
            List<StructuralDiff.FileDiff> diffs = List.of(
                createFileDiff(Path.of("Statics.java"), List.of(change))
            );
        ...
        void nonStaticFieldNotIncluded() {
            StructuralDiff.Change change = createChange(
                StructuralDiff.Change.Kind.MODIFIED,
                StructuralDiff.Change.Category.FIELD,
                "com.example.Instance",
                "field",
                "private String field"
            );
            List<StructuralDiff.FileDiff> diffs = List.of(
                createFileDiff(Path.of("Instance.java"), List.of(change))
            );
        ...
        void modifiedStaticField() {
            ...
            List<StructuralDiff.FileDiff> diffs = List.of(
                createFileDiff(Path.of("Config.java"), List.of(change))
            );
        ...
        void nullDetailTreatedAsNonStatic() {
            ...
            List<StructuralDiff.FileDiff> diffs = List.of(
                createFileDiff(Path.of("Weird.java"), List.of(change))
            );
        ...
        void blankDetailTreatedAsNonStatic() {
            StructuralDiff.Change change = createChange(
                StructuralDiff.Change.Kind.REMOVED,
                StructuralDiff.Change.Category.FIELD,
                "com.example.Empty",
                "field",
                "   "
            ...
            List<StructuralDiff.FileDiff> diffs = List.of(
                createFileDiff(Path.of("Empty.java"), List.of(change))
            );
    ...
    class ComputeOverlapClassLevel {
        ...
        void emptyDepsAndChanges() {
            ...
            int overlap = StructuralChangeAnalyzer.computeOverlap(
                testDeps, testMemberDeps, changedMembers, changedClasses
            );
        ...
        void noOverlap() {
            ...
            int overlap = StructuralChangeAnalyzer.computeOverlap(
                testDeps, null, null, changedClasses
            );
    ...
    class ComputeOverlapClassesClassLevel {
        ...
        void returnsOverlappingSet() {
            ...
            Set<String> result = StructuralChangeAnalyzer.computeOverlapClasses(
                testDeps, null, null, changedClasses
            );
    ...
    class ComputeOverlapMemberLevel {
        ...
        void noMemberDeps() {
            ...
            StructuralChangeAnalyzer.ChangedMembers changedMembers =
                new StructuralChangeAnalyzer.ChangedMembers(
                    changedClasses,
                    Set.of(),
                    Map.of(),
                    Set.of()
            ...
            int overlap = StructuralChangeAnalyzer.computeOverlap(
                testDeps, null, changedMembers, changedClasses
            );
        ...
        void typeLevelChangeAffectsAll() {
            ...
            StructuralChangeAnalyzer.ChangedMembers changedMembers =
                new StructuralChangeAnalyzer.ChangedMembers(
                    ...
                    Set.of(),
                    Map.of(),
                    Set.of("com.example.Foo")  // Type-level change
                );

            int overlap = StructuralChangeAnalyzer.computeOverlap(
                testDeps, testMemberDeps, changedMembers, Set.of()
            );
        ...
        void clinitChangeAffectsAll() {
            ...
            StructuralChangeAnalyzer.ChangedMembers changedMembers =
                new StructuralChangeAnalyzer.ChangedMembers(
                    Set.of("com.example.Config"),
                    Set.of("com.example.Config#<clinit>"),
                    Map.of("com.example.Config", Set.of("<clinit>")),
                    Set.of()
                );
        ...
        void methodChangeOnlyAffectsIfUsed() {
            ...
            Set<String> testMemberDeps = Set.of(
                "com.example.Helper#compute"  // Test uses compute
            );

            StructuralChangeAnalyzer.ChangedMembers changedMembers =
                new StructuralChangeAnalyzer.ChangedMembers(
                    Set.of("com.example.Helper"),
                    Set.of("com.example.Helper#compute", "com.example.Helper#unused"),
                    Map.of("com.example.Helper", Set.of("compute", "unused")),
                    Set.of()
                );
        ...
        void methodChangeDoesNotAffectIfNotUsed() {
            Set<String> testDeps = Set.of("com.example.Helper");
            Set<String> testMemberDeps = Set.of(
                "com.example.Helper#other"  // Test uses other, not compute
            );

            StructuralChangeAnalyzer.ChangedMembers changedMembers =
                new StructuralChangeAnalyzer.ChangedMembers(
                    Set.of("com.example.Helper"),
                    Set.of("com.example.Helper#compute"),
                    Map.of("com.example.Helper", Set.of("compute")),
                    Set.of()
                );
        ...
        void fieldChangeOnlyAffectsIfUsed() {
            ...
            Set<String> testMemberDeps = Set.of(
                "com.example.Data#count"  // Test accesses count
            );

            StructuralChangeAnalyzer.ChangedMembers changedMembers =
                new StructuralChangeAnalyzer.ChangedMembers(
                    Set.of("com.example.Data"),
                    Set.of("com.example.Data#count"),
                    Map.of("com.example.Data", Set.of("count")),
                    Set.of()
                );
        ...
        void initChangeOnlyAffectsIfConstructed() {
            ...
            Set<String> testMemberDeps = Set.of(
                "com.example.MyClass#<init>"  // Test constructs MyClass
            );

            StructuralChangeAnalyzer.ChangedMembers changedMembers =
                new StructuralChangeAnalyzer.ChangedMembers(
                    Set.of("com.example.MyClass"),
                    Set.of("com.example.MyClass#<init>"),
                    Map.of("com.example.MyClass", Set.of("<init>")),
                    Set.of()
                );
        ...
        void multipleAffectedMembers() {
            ...
            StructuralChangeAnalyzer.ChangedMembers changedMembers =
                new StructuralChangeAnalyzer.ChangedMembers(
                    ...
                    Map.of("com.example.Service", Set.of("start", "stop", "state")),
                    Set.of()
                );
    ...
    class ComputeStaticFieldOverlap {
        ...
        void noMemberDeps() {
            int overlap = StructuralChangeAnalyzer.computeStaticFieldOverlap(
                ...
                new StructuralChangeAnalyzer.ChangedMembers(
                    ...
                    Map.of(),
                    Set.of(),
                    Set.of("com.example.Config#VERSION")
                )
            );
        ...
        void nonMatchingStaticFieldsNotCounted() {
            int overlap = StructuralChangeAnalyzer.computeStaticFieldOverlap(
                Set.of("com.example.Config#OTHER"),
                new StructuralChangeAnalyzer.ChangedMembers(
                    Set.of("com.example.Config"),
                    Set.of(),
                    Map.of(),
    ...
    class EdgeCases {
        ...
        void nullDetailInMethod() {
            ...
            List<StructuralDiff.FileDiff> diffs = List.of(
                createFileDiff(Path.of("Foo.java"), List.of(change))
            );
        ...
        void immutableCollectionsReturned() {
            ...
            List<StructuralDiff.FileDiff> diffs = List.of(
                createFileDiff(Path.of("Test.java"), List.of(change))
            );
            ...
            assertThrows(UnsupportedOperationException.class,
                () -> result.changedClasses().add("com.example.Extra"));
            assertThrows(UnsupportedOperationException.class,
        ...
        void emptyMembersIsEmpty() {
            StructuralChangeAnalyzer.ChangedMembers empty =
                StructuralChangeAnalyzer.ChangedMembers.EMPTY;
        ...
        void constructorWith3ArgsInitializesStaticFields() {
            StructuralChangeAnalyzer.ChangedMembers members =
                new StructuralChangeAnalyzer.ChangedMembers(
                    Set.of("com.example.Foo"),
                    Set.of("com.example.Foo#bar"),
                    Map.of("com.example.Foo", Set.of("bar")),
                    Set.of()
                );
        ...
        void multipleDiffsSameClassMerged() {
            List<StructuralDiff.Change> changes1 = List.of(
                createChange(
                    StructuralDiff.Change.Kind.ADDED,
                    StructuralDiff.Change.Category.METHOD,
                    "com.example.Merged",
            ...
            List<StructuralDiff.Change> changes2 = List.of(
                createChange(
                    StructuralDiff.Change.Kind.ADDED,
                    StructuralDiff.Change.Category.METHOD,
                    "com.example.Merged",
            ...
            List<StructuralDiff.FileDiff> diffs = List.of(
                createFileDiff(Path.of("Merged.java"), changes1),
    ...
    class MemberLevelOverlapClassesPrecision {
        ...
        void changedClassNotInDeps() {
            ...
            StructuralChangeAnalyzer.ChangedMembers changedMembers =
                new StructuralChangeAnalyzer.ChangedMembers(
                    ...
                    Set.of(),
                    Map.of("com.example.Bar", Set.of("method")),
                    Set.of()
                );
        ...
        void complexMixOfChanges() {
            Set<String> testDeps = Set.of(
                "com.example.TypeChanged",
                "com.example.ClinitChanged",
                "com.example.MethodChanged",
                "com.example.MethodNotUsed"
            );
            Set<String> testMemberDeps = Set.of(
                "com.example.MethodChanged#compute"
            );
            ...
            StructuralChangeAnalyzer.ChangedMembers changedMembers =
                new StructuralChangeAnalyzer.ChangedMembers(
                    ...
                    Set.of(
                        "com.example.ClinitChanged#<clinit>",
                        "com.example.MethodChanged#compute",
                        "com.example.MethodNotUsed#unused"
                    ),
                    Map.of(
                        "com.example.ClinitChanged", Set.of("<clinit>"),
                        "com.example.MethodChanged", Set.of("compute"),
                        "com.example.MethodNotUsed", Set.of("unused")
                    ),
    ...
    class ChangedMembersRecord {
        ...
        void allComponentsAccessible() {
            ...
            StructuralChangeAnalyzer.ChangedMembers members =
                new StructuralChangeAnalyzer.ChangedMembers(
                    classes, memberKeys, byClass, typeChanged, staticFields
                );
