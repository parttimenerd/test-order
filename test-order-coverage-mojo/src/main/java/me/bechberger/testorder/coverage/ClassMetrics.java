 ...
 * Immutable value object containing all coverage-related information.
 */
public class ClassMetrics implements Comparable<ClassMetrics> {
    ...
    public int getStatementsCovered() { return statementsCovered; }
    public int getStatementsTotal() { return statementsTotal; }
    ...
    public List<String> getTestNames() { return new ArrayList<>(testNames); }
    ...
    /**
     * Whether this class should be skipped from coverage analysis.
     * Skips abstract, interface, and enum classes.
     */
    ...
    public String toString() {
        return String.format("%s (line:%d%%, method:%d%%, branch:%d%%) - %d tests",
            fullyQualifiedName, lineCoverage, methodCoverage, branchCoverage, testCount);
    }
}
