...
public class LeastTestedClassifier {
    ...
    public enum Severity {
        ...
        IMPORTANT("Important", 30, 50),
        REVIEW("Should Review", 50, 70),
        ACCEPTABLE("Acceptable", 70, 100);
    ...
    public Map<Severity, List<ClassMetrics>> classifyByThreshold(int threshold) {
        ...
        result.forEach((severity, classes) ->
                classes.sort(Comparator.comparingInt(ClassMetrics::getLineCoverage))
        );
