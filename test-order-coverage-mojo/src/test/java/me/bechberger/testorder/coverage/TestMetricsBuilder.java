...
public class TestMetricsBuilder {
	public static ClassMetrics create(String fqcn, String module, int lineCoverage, int methodCoverage,
			int branchCoverage, int testCount) {
		...
		return new ClassMetrics(fqcn, module, pkg, className, lineCoverage, methodCoverage, branchCoverage,
				lineCoverage, // statementsCovered
				100, // statementsTotal
				methodCoverage, // methodsCovered
				10, // methodsTotal
				testCount, new ArrayList<>(), false, false, false);
	}
}
