...
/**
 * Integration test for change detection edge cases. Validates that test-order
 * gracefully handles: - Shallow git clones (missing HEAD~1) - Fresh
 * single-commit repositories - Non-git projects (fallback to hash-based
 * detection)
 */
