...
/**
 * Integration test for Spring Boot test slices.
 * Validates that test-order works correctly with:
 * - @DataJpaTest (database-only context)
 * - @WebMvcTest (servlet+Spring context)
 * - @SpringBootTest (full application context)
 *
 * Tests that slices maintain proper context isolation and don't pollute each other's state.
 */
