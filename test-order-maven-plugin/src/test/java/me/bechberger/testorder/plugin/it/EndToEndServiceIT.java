...
/**
 * End-to-end tests against the service example project (8 test classes, rich dependency graph).
 * <p>
 * Dependency graph:
 * <pre>
 *   UserTest              → User
...
class EndToEndServiceIT {
    ...
    void learnModeProducesIndex() {
        ...
        for (String tc : List.of(USER_TEST, ORDER_TEST, USER_VALIDATOR_TEST,
                ORDER_VALIDATOR_TEST, USER_REPO_TEST, ORDER_REPO_TEST,
                USER_SERVICE_TEST, ORDER_SERVICE_TEST)) {
    ...
    void userTestDependencies() {
        DependencyMap depMap = project.loadIndex();
        assertThat(depMap)
                .hasDependency(USER_TEST, USER)
                .doesNotHaveDependency(USER_TEST, ORDER)
                .doesNotHaveDependency(USER_TEST, USER_SERVICE)
                .doesNotHaveDependency(USER_TEST, USER_REPO);
    }
    ...
    void orderTestDependencies() {
        DependencyMap depMap = project.loadIndex();
        assertThat(depMap)
                .hasDependency(ORDER_TEST, ORDER)
                .hasDependency(ORDER_TEST, USER)
                .doesNotHaveDependency(ORDER_TEST, USER_SERVICE)
                .doesNotHaveDependency(ORDER_TEST, ORDER_REPO);
    }
    ...
    void orderServiceTestDependencies() {
        ...
        assertThat(depMap)
                ...
                .hasDependency(ORDER_SERVICE_TEST, ORDER_REPO)
                .hasDependency(ORDER_SERVICE_TEST, ORDER_VALIDATOR)
                .hasDependency(ORDER_SERVICE_TEST, USER_SERVICE)
                .hasDependency(ORDER_SERVICE_TEST, USER_REPO)
                .hasDependency(ORDER_SERVICE_TEST, USER_VALIDATOR)
                .hasDependency(ORDER_SERVICE_TEST, ORDER)
    ...
    void userValidatorTestDependencies() {
        ...
        assertThat(depMap)
                ...
                .hasDependency(USER_VALIDATOR_TEST, USER)
    ...
    void changingUserAffectsMany() {
        ...
        assertThat(affected).contains(USER_TEST, ORDER_TEST, USER_VALIDATOR_TEST,
                ORDER_VALIDATOR_TEST, USER_REPO_TEST, ORDER_REPO_TEST,
                USER_SERVICE_TEST, ORDER_SERVICE_TEST);
    }
    ...
    void changingOrderServiceAffectsOnlyItsTest() {
        ...
        assertThat(affected)
                .contains(ORDER_SERVICE_TEST)
                .doesNotContain(USER_TEST, ORDER_TEST, USER_SERVICE_TEST,
    ...
    void changingUserValidatorAffectsTransitive() {
        ...
        assertThat(affected)
                .contains(USER_VALIDATOR_TEST, ORDER_VALIDATOR_TEST,
                        USER_SERVICE_TEST, ORDER_SERVICE_TEST)
    ...
    void showOrderScoresValidatorHigher() {
        ...
        assertThat(result).succeeded()
                .outputContains("UserValidatorTest")
                .outputContains("OrderValidatorTest");
    }
    ...
    void dumpShowsAllTests() {
        ...
        assertThat(result).succeeded()
                .outputContains("UserTest")
                .outputContains("OrderServiceTest")
