...
class AdvancedWorkflowIT {
    ...
    void orderModeRecordsDurations() {
        ...
        assertThat(calcDur >= 0 || strDur >= 0)
                .as("At least one test duration should be tracked")
                .isTrue();
    }
    ...
    void showOrderCalculatorChangeScoresHigher() {
        ...
        assertThat(calcScore)
                .as("CalculatorTest score should be >= StringUtilsTest score when Calculator changed")
    ...
    void showOrderStringUtilsChangeScoresHigher() {
        ...
        assertThat(strScore)
                .as("StringUtilsTest score should be > CalculatorTest score when StringUtils changed")
    ...
    void selectModeRunsSubset() {
        ...
        assertThat(project.exists("target/test-order-selected.txt")
                ...
                .as("Select mode should write selected or remaining file")
                .isTrue();
    }
    ...
    void orderWithoutDepsDir() {
        ...
        MavenResult result = project.maven().run("clean", "test",
                "-Dtestorder.mode=order", "-Dtestorder.changeMode=explicit");
    ...
    /**
     * Extract the score for a test class from show-order output.
     * The output uses abbreviated names: "c.e.app.CalculatorTest" and columns
     * separated by whitespace (not pipes). Format:
     * <pre>
