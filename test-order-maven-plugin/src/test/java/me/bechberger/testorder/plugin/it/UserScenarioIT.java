 ...
 * 
 * Scenarios covered:
 * 1. Learn mode builds dependency index
 * 2. Order mode prioritizes tests based on code changes
 * 3. Failure tracking - recently failed tests run first
 */
...
class UserScenarioIT {
    ...
    void testLearnModeCreatesIndex() {
        ...
        assertThat(depMap).isLoaded()
                .hasSize(3)
                .hasTestClass(PAYMENT_PROCESSOR_TEST)
                .hasTestClass(USER_VALIDATOR_TEST)
    ...
    void testPaymentProcessorDependencies() {
        ...
        assertThat(depMap)
                .hasDependency(PAYMENT_PROCESSOR_TEST, PAYMENT_PROCESSOR)
    ...
    void testUserValidatorDependencies() {
        ...
        assertThat(depMap)
                .hasDependency(USER_VALIDATOR_TEST, USER_VALIDATOR)
    ...
    void testOrderServiceTransitiveDependencies() {
        ...
        // OrderServiceTest directly depends on OrderService, which depends on PaymentProcessor
        assertThat(depMap)
                .hasDependency(ORDER_SERVICE_TEST, ORDER_SERVICE)
                .hasDependency(ORDER_SERVICE_TEST, PAYMENT_PROCESSOR);
    }
    ...
    void testOrderWhenPaymentProcessorChanges() {
        ...
        for (int i = 0; i < lines.length; i++) {
            if (lines[i].contains("PaymentProcessorTest")) paymentIdx = i;
            if (lines[i].contains("OrderServiceTest")) orderIdx = i;
            if (lines[i].contains("UserValidatorTest")) userIdx = i;
        }
        
        // PaymentProcessorTest should come before OrderServiceTest
        // OrderServiceTest should come before UserValidatorTest
        assertThat(paymentIdx)
                .as("PaymentProcessorTest should appear in output")
                .isGreaterThanOrEqualTo(0);
        assertThat(orderIdx)
                .as("OrderServiceTest should appear in output")
                .isGreaterThanOrEqualTo(0);
        assertThat(userIdx)
                .as("UserValidatorTest should appear in output")
                .isGreaterThanOrEqualTo(0);
        assertThat(paymentIdx)
                .as("PaymentProcessorTest should come before OrderServiceTest")
                .isLessThan(orderIdx);
        assertThat(orderIdx)
                .as("OrderServiceTest should come before UserValidatorTest")
                .isLessThan(userIdx);
    }
    ...
    void testOrderWhenUserValidatorChanges() {
        ...
        assertThat(orderIdx)
                ...
                .isGreaterThanOrEqualTo(0);
        assertThat(userIdx)
                .as("UserValidatorTest should be prioritized first")
                .isLessThan(paymentIdx);
        assertThat(userIdx)
                .as("UserValidatorTest should come before OrderServiceTest")
                .isLessThan(orderIdx);
    }
    ...
    void testOrderModeRunsTestsInOrder() {
        ...
        assertThat(result).succeeded()
                .outputContains("Tests run: 12")
                .outputContains(PAYMENT_PROCESSOR_TEST)
                .outputContains(USER_VALIDATOR_TEST)
                .outputContains(ORDER_SERVICE_TEST);
    }
    ...
    void testFailureTracking() {
        ...
        project.replaceInFile(
                "src/main/java/com/usertest/app/OrderService.java",
        ...
        assertThat(failResult).failed()
                .outputContains("testCalculateTotal");
        ...
        assertThat(passResult).succeeded()
                .outputContains("Tests run: 12");
    }
    ...
    void testMultipleChanges() {
        ...
        // Both PaymentProcessorTest and UserValidatorTest should come before OrderServiceTest
