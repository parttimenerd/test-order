...
/**
 * Maven goal to rebuild the test-order index from all .deps files.
 * Useful for cleaning stale entries or fixing a corrupted index.
 *
    ...
    public void execute() throws MojoExecutionException {
        ...
        try {
            ...
            throw new MojoExecutionException(
                    "[test-order] Failed to compact index: " + e.getMessage(), e);
        }
    }
}
