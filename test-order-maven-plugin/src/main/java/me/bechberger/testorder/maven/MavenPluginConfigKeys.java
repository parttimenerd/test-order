...
final class MavenPluginConfigKeys {
	...
	static final String SCORE_KILL_RATE_BONUS = "testorder.score.killRateBonus";
	...
	/**
	 * Property for enabling verbose explain mode in {@code test-order:show} and
	 * {@code test-order:show-all}.
	 */
	static final String SHOW_EXPLAIN = "testorder.show.explain";
	...
	static final Map<String, String> ALIASES = Map.of(
			...
			// testorder.showOrder.explain → testorder.show.explain (backward compat)
			SHOW_ORDER_EXPLAIN, SHOW_EXPLAIN);
	...
	static final Set<String> ALL_KNOWN_KEYS = Set.of(INDEX_PATH, STATE_PATH, LEARN, INSTRUMENTATION_MODE, CHANGE_MODE,
			...
			SCORE_COVERAGE_BONUS, SCORE_KILL_RATE_BONUS, MODE, INCLUDE_PACKAGES, FILTER_BY_GROUP_ID, SELECT_TOP_N,
			SELECT_RANDOM_M, SELECT_SEED, SELECT_REMAINING_FILE, SELECTED_FILE, AUTO_RUN_REMAINING, AUTO_OPTIMIZE_EVERY,
			AUTO_LEARN_RUN_THRESHOLD, AUTO_LEARN_DIFF_THRESHOLD, DUMP_OUTPUT, EXPORT_JSON_OUTPUT, SHOW_ORDER_EXPLAIN,
			SHOW_METHOD_ORDER_EXPLAIN, SHOW_ORDER_FULL_NAMES, EXPLAIN_TEST, EXPLAIN_TOP_N, SHOW_STATIC_ANALYSIS_VERBOSE,
			COMPRESSION, DASHBOARD_OUTPUT, DASHBOARD_COVERAGE_DIR, DASHBOARD_OPEN, DASHBOARD_SEPARATE_ASSETS,
			...
			TIERED_SHARD, CI_SUMMARY, CI_GITHUB_STEP_SUMMARY, CI_PR_COMMENT, LEGACY_INDEX, LEGACY_STATE_FILE,
			LEGACY_DEPS_DIR, LEGACY_HASH_FILE, LEGACY_TEST_HASH_FILE, LEGACY_METHOD_HASH_FILE, BYTECODE_HASH_FILE,
			BYTECODE_CHANGE_DETECTION_ENABLED, BYTECODE_AUGMENT_DEPENDENCY_MAP_ENABLED, LEGACY_SOURCE_ROOT,
			LEGACY_TEST_SOURCE_ROOT, LEGACY_VERBOSE_FILE, LEGACY_METHOD_ORDERING_ENABLED, AUTO_COMPACT_EVERY,
			SELECTIVE_LEARN, ALWAYS_LEARN, "testorder.skip", "testorder.debug", "testorder.history.maxRuns",
			"testorder.changed.classes.file", "testorder.score.springContextGrouping", "testorder.auto.active",
