#!/usr/bin/env bash
# =============================================================================
# toggle-test-order.sh — Add or remove test-order from cloud-sdk-java
# =============================================================================
# cloud-sdk-java already uses JUnit 5 — only the plugin block is needed.
#
# Usage:
#   ./toggle-test-order.sh on    # Add test-order plugin
#   ./toggle-test-order.sh off   # Remove test-order plugin
#   ./toggle-test-order.sh       # Toggle
# =============================================================================
set -euo pipefail
...
disable() {
    ...
    echo ""
    echo "  ❌ test-order plugin REMOVED"
    echo ""
    show_diff
}
...
case "${1:-toggle}" in
    ...
    diff|show)
        ...
        ;;
    *)
        echo "Usage: $0 [on|off|toggle|diff]"
        exit 1
        ;;
esac
