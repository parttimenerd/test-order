...
/**
 * Circular dependency: OrderService → InventoryService → OrderService. Tests
 * whether the plugin handles circular dependency graphs without infinite loops
 * or incorrect overlap computation.
 */
