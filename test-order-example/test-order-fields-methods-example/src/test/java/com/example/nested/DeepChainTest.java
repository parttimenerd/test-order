...
/**
 * Traverses the full chain: Company → Department → Team → Employee. Should
 * depend on ALL four classes.
 */
class DeepChainTest {
	...
	void traverseFullChain() {
		String leadName = company.getEngineering().getFrontendTeam().getLead().getName();
