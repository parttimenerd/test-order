...
class UserServiceTest {
	...
	void registerInvalidUserThrows() {
		assertThrows(IllegalArgumentException.class, () -> service.register("", "alice@example.com"));
	}

	@Test
	void registerDuplicateEmailThrows() {
		service.register("Alice", "alice@example.com");
		assertThrows(IllegalStateException.class, () -> service.register("Alice2", "alice@example.com"));
	}
